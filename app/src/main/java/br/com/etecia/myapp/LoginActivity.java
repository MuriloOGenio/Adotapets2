...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEntrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (usuario.equals("etecia") && senha.equals("etecia")) {
                    ...
                    Toast.makeText(getApplicationContext(), "Usuário ou senha inválidas", Toast.LENGTH_SHORT).show();
                }
            }
        });
        lblCadastrarUsuario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), CadUsuActivity.class));
            }
        });
